...
FIND_LIBRARY(ALLEGRO5DEPS_LIBRARIES NAMES jpeg zlib freetype FLAC dumb vorbisfile vorbis ogg opusfile opus theoradec ${ALLEGRO_LIBS_DEPS_PNG16} ${ALLEGRO5DEPS_PKG_LIBRARIES}
  PATHS
    ...
    /usr/X11
    /usr
	${CMAKE_BINARY_DIR}/packages/AllegroDeps/build/native/v140/x64/deps
	${CMAKE_BINARY_DIR}/packages/AllegroDeps/build/native/v140/win32/deps
	${CMAKE_BINARY_DIR}/packages/AllegroDeps/build/native/v141/x64/deps
	${CMAKE_BINARY_DIR}/packages/AllegroDeps/build/native/v141/win32/deps
	${ALLEGRODEPS_LIB}
  HINTS
