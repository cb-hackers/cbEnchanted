...
FORCEINLINE void CBEnchanted::handleCommand(void) {
	...
	switch (command) {
		...
		case 6: caller.commandSelect(); break;
		case 7: caller.commandCase(); break;
		...
		case 12: caller.commandGoto(); break;
		case 21: caller.commandGosub(); break;
		case 22: caller.commandReturn(); break;
		case 42: caller.commandDim(); break;
		case 43: caller.commandReDim(); break;
		case 44: caller.commandClearArray(); break;
		case 56: caller.commandInsert(); break;
		case 57: caller.commandDelete(); break;
		case 65: caller.commandInitObjectList(); break;
		case 69: caller.commandEnd(); break;
		case 70: popValue(); break;
		case 77: caller.commandSetVariable(); break;
		case 78: caller.commandArrayAssign(); break;
		case 79: caller.commandFunction(); break;
		case 80: caller.commandSetGlobalVariable(); break;
		case 81: caller.commandSetTypeMemberField(); break;
		case 95: caller.commandType(); break;
		case 97: caller.commandSetArrayNumbers(); break;
		case 98: caller.commandSetGlobalVariableNumbers(); break;
		case 99: caller.commandSetVariableNumbers(); break;
...
void CBEnchanted::handleFunction(void) {
	...
	switch(func) {
		case 50: caller.functionNew(); break;
		case 52: caller.functionFirst(); break;
		case 53: caller.functionLast(); break;
		case 54: caller.functionBefore(); break;
		case 55: caller.functionAfter(); break;
		case 61: caller.functionRead(); break;
		case 63: caller.functionConvertToInteger(); break;
		case 64: caller.functionConvertToType(); break;
