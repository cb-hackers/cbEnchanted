...
void MemInterface::commandDeleteMEMBlock(void) {
    int32_t *mem = (int32_t *)cb->popValue().toInt();
	delete mem;
}

//ResizeMEMblock
void MemInterface::commandResizeMEMBlock(void) {
    int32_t size = cb->popValue().toInt();
    int32_t *mem = (int32_t *)cb->popValue().toInt();
...
void MemInterface::commandMemCopy(void) {
    int32_t lenght = cb->popValue().toInt();
    int32_t dest = cb->popValue().toInt();
    int32_t *destmem = (int32_t *)cb->popValue().toInt();
    int32_t src = cb->popValue().toInt();
    int32_t *srcmem = (int32_t *)cb->popValue().toInt();
	memcpy(destmem + dest + 4, srcmem + src + 4, lenght);
}

//PokeByte
void MemInterface::commandPokeByte(void) {
    uint8_t value = cb->popValue().cast_to_byte();
    int32_t position  = cb->popValue().toInt();
    unsigned char * mem = (uint8_t *)cb->popValue().toInt();
	*((uint8_t *)(mem + position + 4)) = value;
}

//PokeShort
void MemInterface::commandPokeShort(void) {
    uint16_t value = cb->popValue().cast_to_short();
    int32_t position  = cb->popValue().toInt();
    uint8_t *mem = (uint8_t *)cb->popValue().toInt();
	*((uint16_t *)(mem + position + 4)) = value;
}

//PokeInt
void MemInterface::commandPokeInt(void){
    int32_t value = cb->popValue().toInt();
    int32_t position = cb->popValue().toInt();
    uint8_t *mem = (uint8_t *)cb->popValue().toInt();
...
void MemInterface::commandPokeFloat(void){
    float value = cb->popValue().cast_to_float();
    int32_t position  = cb->popValue().toInt();
    uint8_t *mem = (uint8_t *)cb->popValue().toInt();
...
void MemInterface::functionPeekShort(void) {
    int32_t position = cb->popValue().toInt();
    uint16_t *mem = (uint16_t *)cb->popValue().toInt();
...
void MemInterface::functionPeekFloat(void){
    int32_t position = cb->popValue().toInt();
    float *mem = (float *)cb->popValue().toInt();
